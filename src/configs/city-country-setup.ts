...
export function SetCountries() {
	...
	CountrySettings.push({
		...
		cities: [
			{
				barrack: { x: 768.0, y: -2048.0 },
			},
			{
				barrack: { x: 2112.0, y: -1664.0 },
			},
		],
	});
	CountrySettings.push({
		...
		cities: [
			{
				barrack: { x: 1408.0, y: -3008.0 },
			},
			{
				barrack: { x: 448.0, y: -3648.0 },
			},
		],
	});
	CountrySettings.push({
		...
		cities: [
			{
				barrack: { x: 1856.0, y: -4032.0 },
			},
			{
				barrack: { x: 896.0, y: -4736.0 },
			},
		],
	});
	CountrySettings.push({
		...
		cities: [
			{
				barrack: { x: 2880.0, y: -4864.0 },
			},
			{
				barrack: { x: 1920.0, y: -5760.0 },
			},
		],
	});
	CountrySettings.push({
		...
		cities: [
			{
				barrack: { x: 3456.0, y: -5632.0 },
			},
			{
				barrack: { x: 2752.0, y: -6656.0 },
			},
		],
	});
	CountrySettings.push({
		...
		cities: [
			{
				barrack: { x: 3776.0, y: -6656.0 },
			},
			{
				barrack: { x: 4736.0, y: -6720.0 },
			},
		],
	});
	CountrySettings.push({
		...
		cities: [
			{
				barrack: { x: 4416.0, y: -4992.0 },
			},
			{
				barrack: { x: 5248.0, y: -5568.0 },
			},
		],
	});
	CountrySettings.push({
		...
		cities: [
			{
				barrack: { x: 5952.0, y: -6848.0 },
			},
			{
				barrack: { x: 5440.0, y: -7872.0 },
			},
		],
	});
	CountrySettings.push({
	...
	CountrySettings.push({
		...
		cities: [
			...
			{
				barrack: { typeId: UNIT_ID.PORT, x: 6112.0, y: -11232.0 },
				cityType: 'port',
			},
			{
	...
	CountrySettings.push({
		...
		cities: [
			{
				barrack: { x: 6784.0, y: -6016.0 },
			},
			{
				barrack: { x: 7808.0, y: -5952.0 },
			},
		],
	});
	CountrySettings.push({
	...
	CountrySettings.push({
		...
		cities: [
			{
				barrack: { x: 7296.0, y: -2496.0 },
			},
			{
				barrack: { x: 8384.0, y: -3136.0 },
			},
		],
	});
	CountrySettings.push({
	...
	CountrySettings.push({
		...
		cities: [
			...
			{
				barrack: { typeId: UNIT_ID.PORT, x: 11360.0, y: -10336.0 },
				cityType: 'port',
			},
			{
				barrack: { typeId: UNIT_ID.PORT, x: 8800.0, y: -7392.0 },
				cityType: 'port',
			},
		],
	});
	CountrySettings.push({
		...
		cities: [
			{
				barrack: { x: 16064.0, y: -4096.0 },
			},
			{
				barrack: { x: 14976.0, y: -3648.0 },
			},
		],
	});
	CountrySettings.push({
		...
		cities: [
			{
				barrack: { x: 17472.0, y: -9664.0 },
			},
			{
				barrack: { x: 16064.0, y: -9408.0 },
			},
			{
				barrack: { x: 16512.0, y: -10880.0 },
			},
		],
	});
	CountrySettings.push({
		...
		cities: [
			{
				barrack: { x: 14784.0, y: -9600.0 },
			},
			{
				barrack: { x: 14976.0, y: -11136.0 },
			},
		],
	});
	CountrySettings.push({
	...
	CountrySettings.push({
		...
		cities: [
			{
				barrack: { x: 14976.0, y: -13440.0 },
			},
			{
				barrack: { typeId: UNIT_ID.PORT, x: 13900.0, y: -12320.0 },
				cityType: 'port',
			},
		],
	});
	CountrySettings.push({
		...
		cities: [
			{
				barrack: { x: 17344.0, y: -12480.0 },
			},
			{
				barrack: { x: 17728.0, y: -13440.0 },
			},
			{
				barrack: { x: 16128.0, y: -14272.0 },
			},
		],
	});
	CountrySettings.push({
	...
	CountrySettings.push({
		...
		cities: [
			...
			{
				barrack: { typeId: UNIT_ID.PORT, x: 5088.0, y: -14112.0 },
				cityType: 'port',
			},
		],
	});
	CountrySettings.push({
		...
		cities: [
			{
				barrack: { x: -1408.0, y: -13824.0 },
			},
			{
				barrack: { typeId: UNIT_ID.PORT, x: -160.0, y: -14496.0 },
				cityType: 'port',
			},
		],
	});
	CountrySettings.push({
		...
		cities: [
			{
				barrack: { x: -3648.0, y: -14144.0 },
			},
			{
				barrack: { x: -5760.0, y: -15040.0 },
			},
			{
				barrack: { x: -7360.0, y: -14336.0 },
			},
		],
	});
	CountrySettings.push({
		...
		cities: [
			...
			{
				barrack: { typeId: UNIT_ID.PORT, x: -12320.0, y: -14368.0 },
				cityType: 'port',
			},
		],
	});
	CountrySettings.push({
		...
		cities: [
			...
			{
				barrack: { typeId: UNIT_ID.PORT, x: -12000.0, y: -7968.0 },
				cityType: 'port',
			},
		],
	});
	...
	CountrySettings.push({
		...
		cities: [
			...
			{
				barrack: { typeId: UNIT_ID.PORT, x: -6944.0, y: -4704.0 },
				cityType: 'port',
			},
			{
				barrack: { typeId: UNIT_ID.PORT, x: -4384.0, y: -7008.0 },
				cityType: 'port',
			},
		],
	});
	CountrySettings.push({
		...
		cities: [
			{
				barrack: { x: -2432.0, y: -4160.0 },
			},
			{
				barrack: { x: -1280.0, y: -4352.0 },
			},
		],
	});
	CountrySettings.push({
	...
	CountrySettings.push({
		...
		cities: [
			{
				barrack: { x: -3072.0, y: -2368.0 },
			},
			{
				barrack: { typeId: UNIT_ID.PORT, x: -4384.0, y: -608.0 },
			},
		],
	});
	CountrySettings.push({
		...
		cities: [
			...
			{
				barrack: { typeId: UNIT_ID.PORT, x: -3168.0, y: 480.0 },
				cityType: 'port',
			},
		],
	});
	CountrySettings.push({
		...
		cities: [
			...
			{
				barrack: { typeId: UNIT_ID.PORT, x: -2272.0, y: 2464.0 },
				cityType: 'port',
			},
		],
	});
	CountrySettings.push({
		...
		cities: [
			...
			{
				barrack: { typeId: UNIT_ID.PORT, x: -2464.0, y: 3680.0 },
				cityType: 'port',
			},
			{
				barrack: { typeId: UNIT_ID.PORT, x: -1760.0, y: 7904.0 },
				cityType: 'port',
			},
		],
	});
	CountrySettings.push({
		...
		cities: [
			...
			{
				barrack: { typeId: UNIT_ID.PORT, x: 1760.0, y: 3040.0 },
				cityType: 'port',
			},
		],
	});
	CountrySettings.push({
		...
		cities: [
			...
			{
				barrack: { typeId: UNIT_ID.PORT, x: 3424.0, y: 9184.0 },
				cityType: 'port',
			},
		],
	});
	CountrySettings.push({
		...
		cities: [
			...
			{
				barrack: { typeId: UNIT_ID.PORT, x: -8352.0, y: -672.0 },
				cityType: 'port',
			},
		],
	});
	CountrySettings.push({
		...
		cities: [
			...
			{
				barrack: { typeId: UNIT_ID.PORT, x: -10208.0, y: 4000.0 },
				cityType: 'port',
			},
			{
				barrack: { typeId: UNIT_ID.PORT, x: -11488.0, y: 800.0 },
				cityType: 'port',
			},
		],
	});
	CountrySettings.push({
		...
		cities: [
			...
			{
				barrack: { typeId: UNIT_ID.PORT, x: -7200.0, y: 7968.0 },
				cityType: 'port',
			},
			{
				barrack: { typeId: UNIT_ID.PORT, x: -5920.0, y: 10464.0 },
				cityType: 'port',
			},
		],
	});
	CountrySettings.push({
		...
		cities: [
			{
				barrack: { x: -576.0, y: 14912.0 },
			},
			{
				barrack: { typeId: UNIT_ID.PORT, x: -1760.0, y: 14496.0 },
				cityType: 'port',
			},
		],
	});
	CountrySettings.push({
		...
		cities: [
			{
				barrack: { x: 5056.0, y: 5312.0 },
			},
			{
				barrack: { typeId: UNIT_ID.PORT, x: 4128.0, y: 4640.0 },
				cityType: 'port',
			},
		],
	});
	CountrySettings.push({
		...
		cities: [
			{
				barrack: { x: 5440.0, y: 3520.0 },
			},
			{
				barrack: { typeId: UNIT_ID.PORT, x: 3104.0, y: 3616.0 },
				cityType: 'port',
			},
		],
	});
	CountrySettings.push({
		...
		cities: [
			{
				barrack: { x: 5312.0, y: 2048.0 },
			},
			{
				barrack: { x: 4160.0, y: 2496.0 },
			},
		],
	});
	CountrySettings.push({
		...
		cities: [
			{
				barrack: { x: 4096.0, y: 1344.0 },
			},
			{
				barrack: { typeId: UNIT_ID.PORT, x: 2976.0, y: 1952.0 },
				cityType: 'port',
			},
		],
	});
	...
	CountrySettings.push({
		...
		cities: [
			{
				barrack: { x: 896.0, y: -13120.0 },
			},
			{
				barrack: { typeId: UNIT_ID.PORT, x: 2410.0, y: -12836.0 },
				cityType: 'port',
			},
		],
	});
	...
	CountrySettings.push({
		...
		cities: [
			{
				barrack: { x: 3968.0, y: -2304.0 },
			},
			{
				barrack: { x: 2752.0, y: -2624.0 },
			},
		],
	});
	CountrySettings.push({
		...
		cities: [
			{
				barrack: { x: 4416.0, y: -3200.0 },
			},
			{
				barrack: { x: 3136.0, y: -3776.0 },
			},
		],
	});
	CountrySettings.push({
	...
	CountrySettings.push({
		...
		cities: [
			...
			{
				barrack: { typeId: UNIT_ID.PORT, x: -11040.0, y: 12960.0 },
				cityType: 'port',
			},
		],
	});
	CountrySettings.push({
		...
		cities: [
			{
				barrack: { x: -6016.0, y: 15424.0 },
			},
			{
				barrack: { typeId: UNIT_ID.PORT, x: -5600.0, y: 14048.0 },
				cityType: 'port',
			},
		],
	});
	CountrySettings.push({
		...
		cities: [
			{
				barrack: { x: 3264.0, y: 13504.0 },
			},
			{
				barrack: { x: 4160.0, y: 13056.0 },
			},
		],
	});
	CountrySettings.push({
		...
		cities: [
			...
			{
				barrack: { typeId: UNIT_ID.PORT, x: -6432.0, y: 4960.0 },
				cityType: 'port',
			},
		],
	});
	CountrySettings.push({
		...
		cities: [
			{
				barrack: { x: 10496.0, y: 16064.0 },
			},
			{
				barrack: { typeId: UNIT_ID.PORT, x: 11936.0, y: 15584.0 },
				cityType: 'port',
			},
		],
	});
	CountrySettings.push({
		...
		cities: [
			{
				barrack: { x: 11456.0, y: -3264.0 },
			},
			{
				barrack: { typeId: UNIT_ID.PORT, x: 10464.0, y: -4128.0 },
				cityType: 'port',
			},
		],
	});
	CountrySettings.push({
		...
		cities: [
			{
				barrack: { x: 18432.0, y: -3584.0 },
			},
			{
				barrack: { x: 17472.0, y: -4352.0 },
			},
		],
	});
	CountrySettings.push({
	...
	CountrySettings.push({
		...
		cities: [
			...
			{
				barrack: { typeId: UNIT_ID.PORT, x: 13024.0, y: -3808.0 },
				cityType: 'port',
			},
		],
	});
	CountrySettings.push({
		...
		cities: [
			{
				barrack: { x: 15424.0, y: 5376.0 },
			},
			{
				barrack: { x: 18048.0, y: 6720.0 },
			},
			{
				barrack: { x: 17984.0, y: 3840.0 },
			},
		],
	});
	CountrySettings.push({
	...
	CountrySettings.push({
		...
		cities: [
			{
				barrack: { x: 16576.0, y: 15744.0 },
			},
			{
				barrack: { x: 18176.0, y: 15616.0 },
			},
		],
	});
	CountrySettings.push({
		...
		cities: [
			{
				barrack: { x: 15296.0, y: 8960.0 },
			},
			{
				barrack: { x: 13952.0, y: 8384.0 },
			},
		],
	});
	CountrySettings.push({
	...
	CountrySettings.push({
		...
		cities: [
			{
				barrack: { x: -8000.0, y: 2304.0 },
			},
			{
				barrack: { x: -8512.0, y: 1216.0 },
			},
		],
	});
	CountrySettings.push({
		...
		cities: [
			{
				barrack: { typeId: UNIT_ID.PORT, x: -2400.0, y: -7400.0 },
				cityType: 'port',
			},
			{
				barrack: { typeId: UNIT_ID.PORT, x: -1376.0, y: -8928.0 },
				cityType: 'port',
			},
		],
	});
	CountrySettings.push({
		...
		cities: [
			{
				barrack: { typeId: UNIT_ID.PORT, x: 8864.0, y: -11680.0 },
				cityType: 'port',
			},
			{
				barrack: { typeId: UNIT_ID.PORT, x: 7008.0, y: -12192.0 },
				cityType: 'port',
			},
		],
	});
	CountrySettings.push({
		...
		cities: [
			{
				barrack: { typeId: UNIT_ID.PORT, x: 13408.0, y: -10272.0 },
				cityType: 'port',
			},
			{
				barrack: { typeId: UNIT_ID.PORT, x: 12576.0, y: -11808.0 },
				cityType: 'port',
			},
		],
	});
