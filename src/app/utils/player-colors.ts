...
export const pingRedPercent = [
	100.0, 0.0, 10.98, 32.94, 100.0, 99.61, 12.55, 89.8, 58.43, 49.41, 6.27, 29.02, 60.78, 0.0, 0.0, 74.51, 92.16, 97.25,
	74.9, 86.27, 15.69, 92.16, 0.0, 64.31,
];

export const pingGreenPercent = [
	1.18, 25.88, 90.2, 0.0, 98.82, 54.12, 75.29, 35.69, 58.82, 74.9, 38.43, 16.47, 0.0, 0.0, 91.76, 0.0, 80.39, 64.31,
	100.0, 72.55, 15.69, 94.12, 47.06, 43.53,
];

export const pingBluePercent = [
	1.18, 100.0, 72.55, 50.59, 0.0, 5.49, 0.0, 69.02, 59.22, 94.51, 27.45, 1.57, 0.0, 76.47, 100.0, 99.61, 52.94, 54.51,
	50.2, 92.16, 15.69, 100.0, 11.76, 20.0,
];
